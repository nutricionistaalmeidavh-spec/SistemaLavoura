...
function FieldControl({definition,value,onChange}){
  ...
  const type=['number','date','datetime-local'].includes(definition.type)?definition.type:'text';
